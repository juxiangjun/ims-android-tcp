...
public class MsgProtocol {
	...
	public class Command {
        ...
        /**重复登录*/
        public final static int DUPLICATE_REGISTRATION = 0x0003;
        /**Heart beat **/
        public final static int HEART_BEAT = 0x0004;
		...
		/**加为黑名单*/
		public final static int ADD_FRIEND_TO_BLACKLIST = 0x3004;
		
		
		/**邀请加入对讲*/
		public final static int INVITE_TALK = 0x4001;
		
		public final static int ACCEPT_TALK = 0x4002;
		
		public final static int TALK_START = 0x4003;
		
		public final static int TALK_END = 0x4004;
		
		public final static int TALK_EXCEPTION = 0x4005;
