...
#include <stdio.h>
#include <jni.h>
#include <aac/inc/voAAC.h>
#include <aac/inc/cmnMemory.h>
...
void
Java_com_eme_ims_audio_AACEncoder_init( JNIEnv* env,
                                         jobject thiz,
                                         int bitrate,
                                         int channels,
                                         int sampleRate,
...
int
Java_com_eme_ims_audio_AACEncoder_encode( JNIEnv* env,
                                           jobject thiz,
                                           ...
                                           jbyteArray outputArray)
{
  ...
  for(i = 0; i < inputSize; i += readSize) {
    ...
    memcpy(outbuf, outputArray, result*sizeof(jbyte));
    (*env)->SetByteArrayRegion(env, outputArray, 0, result, outbuf);
...
void
Java_com_eme_ims_audio_AACEncoder_uninit( JNIEnv* env,
                                           jobject thiz)
{
